package com.example.corso.ajax.config.front;
...
@EnableWebMvc
@Configuration
@ComponentScan(basePackages = "com.example.corso.ajax.controller")
public class CorsoAjaxFrontConfig extends WebMvcConfigurerAdapter {
